...
class InputFrame(tk.Frame):
    ...
    def analyze_data(self):
        ...
        self.a_label = ctk.CTkLabel(self.av_frame,
                                    text='Enter the type of analysis you would like to perform:\n(Options '
                                         'include data summary and filtering.\n If '
        ...
        self.a_exit_button = ctk.CTkButton(self.av_frame,
                                           ...
                                           border_color='#F6B17A',
                                           border_width=2,
                                           command=self.a_exit_visualize_data)
        self.a_exit_button.pack(side='top', pady=10)

    def a_exit_visualize_data(self):
    ...
    def a_select_data(self):
        ...
        self.tree_frame = tk.Frame(self.av_frame, width=450, height=220)
        self.tree_frame.pack_propagate(0)
        self.tree_frame.pack()

        tree_scrollbar_y = tk.Scrollbar(self.tree_frame, orient="vertical")
        tree_scrollbar_y.pack(side='left', fill='y')

        tree_scrollbar_x = tk.Scrollbar(self.tree_frame, orient="horizontal")
        tree_scrollbar_x.pack(side='bottom', fill='x')

        tree = ttk.Treeview(self.tree_frame, yscrollcommand=tree_scrollbar_y.set, xscrollcommand=tree_scrollbar_x.set,
                            show='headings')
    ...
    def visualize_data(self):
        ...
        self.v_exit_button = ctk.CTkButton(self.av_frame,
                                           ...
                                           border_color='#F6B17A',
                                           border_width=2,
                                           command=self.v_exit_visualize_data)
        self.v_exit_button.pack(side='top', pady=10)

    def v_exit_visualize_data(self):
